  ...
  Future<void> _saveBranch() async {
    ...
    try {
      ...
      final data = {
        ...
        'bookingLimitPerDay': int.tryParse(_bookingLimitController.text) ?? 0,
        'status': _status,
        'timezone': _timezone,
        'hours': _hours,
        'serviceIds': [],
                        ...
                        children: [
                          ...
                          Expanded(
                            child: TextFormField(
                              ...
                              decoration: _inputDecoration('Daily Booking Limit', '25'),
                              keyboardType: TextInputType.number,
                              validator: (v) {
                                if (v == null || v.isEmpty) return 'Required';
                                final bookingLimit = int.tryParse(v);
                  ...
                  child: Column(
                    children: [
                      ...
                      if (widget.branch.bookingLimitPerDay != null) ...[
                        const Divider(height: 20),
                        _buildDetailRow('Daily Booking Limit', '${widget.branch.bookingLimitPerDay} bookings'),
                      ],
                      const Divider(height: 20),
                      Row(
