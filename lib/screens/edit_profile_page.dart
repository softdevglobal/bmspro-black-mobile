            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    const Text('Edit Profile', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w800, color: Colors.white, letterSpacing: -0.5)),
                    Text('Update your personal info', style: TextStyle(fontSize: 12, color: Colors.white.withOpacity(0.5))),
                  ],
                ),
              ),
            ],
